/**
 * 
 * admin:printposter, scripts of shade.cd
 * Copyright (c) 2012 Dast(http://dastsoft.cz)
 */

$(document).ready(function(){

	$("#itemslist").on('change', 'input[type="checkbox"]', function(){
		var int_checked = this.checked ? 1 : 0 ;
		$.get("?do=ChangeDisplay&itemid="+this.id+"&checked="+int_checked);
	});
	
	$("#itemslist").on('click', 'a.delete', function(e){
		e.preventDefault();
